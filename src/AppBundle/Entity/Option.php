...
class Option
{
     ...
     * Set logo
     *
     * @param \AppBundle\Entity\Media $logo
     *
     * @return Option
     */
    public function setLogo(\AppBundle\Entity\Media $logo = null)
    {
        $this->logo = $logo;
     ...
     * Set favicon
     *
     * @param \AppBundle\Entity\Media $favicon
     *
     * @return Option
     */
    public function setFavicon(\AppBundle\Entity\Media $favicon = null)
    {
