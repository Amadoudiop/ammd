    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if( $file != null )
            {
                ...
                $team->getMedia()->setExtension($fileName['extension']);
                $team->getMedia()->setName($fileName['name']);
                $team->getMedia()->setThumb($fileName['thumb']);
    ...
    public function editAction(Request $request, Team $team)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            if( $file != null )
            {
                ...
                $fileHandler = $this->container->get('file_handler');
                $fileName = $fileHandler->upload($file,  $this->getParameter('simple_directory'), 360, 290);
